...
let historiaGato = "Mi gato se llama "+ nombreGato+ ", tiene " + edadGato + " años y pesa " + pesoGato + " kilos. Es de color " + colorGato + " tiene una personalidad " + personalidadGato + ". Le encanta comer " + comidaFavorita + " y tiene " + numJuguetes + " juguetes diferentes. Necesita dormir al menos " + numHorasSueño + " horas al día. Ahora mismo está jugando con su " + jugandoAhora + ". !Es un gato muy feliz¡" ; // modificar solamente  esta línea
